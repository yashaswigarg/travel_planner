...
ORCHESTRATOR_MODEL = os.environ.get("ORCHESTRATOR_MODEL", "gemini-2.5-flash-lite")

# Groq API (30 RPM)
FLIGHT_WORKER_MODEL = os.environ.get("FLIGHT_WORKER_MODEL", "llama-3.1-8b-instant")

# Cerebras Cloud (High token throughput)
ACCOMMODATION_WORKER_MODEL = os.environ.get("ACCOMMODATION_WORKER_MODEL", "llama-3.1-8b")
...
QA_AGENT_MODEL = os.environ.get("QA_AGENT_MODEL", "openai/gpt-oss-20b:free")
